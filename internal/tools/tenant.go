...
func newTenantTools() []*Tool {
	get_suprsend_tenant := &Tool{
		...
		MCPTool: mcp.NewTool("get_suprsend_tenant",
			...
			utils.McpStringField("tenant_id", "The tenant_id of the tenant to get.", true),
			utils.McpStringField("workspace", "SuprSend workspace to get the user from.", true),
	...
	upsert_suprsend_tenant := &Tool{
		...
		MCPTool: mcp.NewTool("upsert_suprsend_tenant",
			...
			utils.McpStringField("tenant_id", "The tenant_id of the tenant to upsert.", true),
			utils.McpStringField("workspace", "SuprSend workspace to get the user from.", true),
